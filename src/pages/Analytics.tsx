...
export default function Analytics() {
  ...
  const { logs, loading } = useAllLogs(teacherId)
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '1.25rem 1.5rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <Link to={`/t/${teacherId}/dashboard`} style={{ width: 34, height: 34, borderRadius: 8, background: C.cloud, border: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', color: C.slate }}>
